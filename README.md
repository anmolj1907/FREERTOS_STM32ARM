...
| # | Title | Concepts |
|---|-------|----------|
| exp1 | GPIO Digital Output — LED Blink | GPIO Output, Software Delay |
| exp2 | GPIO Digital Input — Push Button LED Toggle | GPIO Input, Debouncing |
| exp3 | HC-SR04 Ultrasonic Sensor — Distance Classification | GPIO, Timer, USART, Sensor Interfacing |
| exp4 | PWM LED Brightness Control | Timer, PWM, Duty Cycle |
| exp5 | FreeRTOS — LED Blink via Single Task | FreeRTOS, Task Creation, vTaskDelay |
| exp6 | FreeRTOS — Dual Task Priority Analysis | FreeRTOS, Task Priority, Preemption |
| exp7 | FreeRTOS — Dual Task Priority with SWV ITM Tracing | FreeRTOS, CMSIS-V2, SWV ITM Console, Priority Scheduling |
| exp8 | FreeRTOS — Binary Semaphore with EXTI Button Interrupt | FreeRTOS, Binary Semaphore, EXTI, Deferred Interrupt Processing |
| exp9 | FreeRTOS — Inter-Task Communication via Queue | FreeRTOS, Queue, FIFO, Sensor Data Transfer |
| exp10 | FreeRTOS — Counting Semaphore Resource Access Control | FreeRTOS, Counting Semaphore, Resource Sharing, Task Interleaving |
...
### exp1 — GPIO Digital Output (LED Blink)
...
### exp2 — GPIO Digital Input (Push Button LED Toggle)
...
### exp3 — HC-SR04 Ultrasonic Sensor with USART
...
### exp4 — PWM LED Brightness Control
...
### exp5 — FreeRTOS LED Blink via Single Task
...
### exp6 — FreeRTOS Dual Task Priority Analysis
...
### exp7 — FreeRTOS Dual Task Priority with SWV ITM Tracing
...
### exp8 — FreeRTOS Binary Semaphore with EXTI Button Interrupt
...
### exp9 — FreeRTOS Inter-Task Communication via Queue
...
### exp10 — FreeRTOS Counting Semaphore — Shared Resource Access Control
...
### Clone the Repo
```bash
git clone https://github.com/anmolj1907/FREERTOS_STM32ARM.git
```
...
**Anmol**  
GitHub: [@anmolj1907](https://github.com/anmolj1907)
